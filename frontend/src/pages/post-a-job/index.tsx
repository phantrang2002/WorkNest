...
import { PostAJob } from '@/api/jobService';
import { useRouter } from 'next/router';
import { TextField, MenuItem, Button, FormControlLabel, Checkbox, Link } from '@mui/material';
...
const PostAJobPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const selectedLocationObj = locations.find(loc => loc.province_id === selectedLocation);
        const locationName = selectedLocationObj ? selectedLocationObj.province_name : '';
        ...
        try {
            ...
            if (response) {
                ...
                console.error('Error posting job3:', response);
            }
        } catch (error) {
                ...
                <main className="p-8 bg-gray-50 text-gray-900 h-fit">
                    ...
                    {!isProfileComplete && (
                        <div className="text-center text-red-500 mb-4">
                            <p>
                                Your profile information is incomplete. Please update it on the{' '}
                                <Link href="/my-company-profile/edit" className="text-blue-500 underline">
                                    Profile page
                                </Link>{' '}
