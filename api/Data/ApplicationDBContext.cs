...
namespace api.Data
{
    public class ApplicationDBContext : IdentityDbContext<Account>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
           ...
           // Cấu hình khóa ngoại giữa Candidate và Account
            builder.Entity<Candidate>()
                .HasOne(c => c.Account)
                .WithOne(a => a.Candidate)
                .HasForeignKey<Candidate>(c => c.CandidateID)
                .OnDelete(DeleteBehavior.Cascade);  // Tự động xóa khi tài khoản bị xóa

            // Cấu hình khóa ngoại giữa Employer và Account
            ...
            // Configure ApplyForm relationships
   ...
   builder.Entity<Policy>()
             ...
             // Cấu hình ràng buộc khóa ngoại cho ApplyForm
            // Cấu hình ràng buộc khóa ngoại cho ApplyForm
            builder.Entity<ApplyForm>()
