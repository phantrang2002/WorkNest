        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Candidate_AspNetUsers_CandidateID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplyForm", x => new { x.JobPostingID, x.CandidateID });
                    table.ForeignKey(
                        name: "FK_ApplyForm_Candidate_CandidateID",
                        column: x => x.CandidateID,
                        principalTable: "Candidate",
                        principalColumn: "CandidateID");
                    table.ForeignKey(
                        name: "FK_ApplyForm_JobPosting_JobPostingID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2c600ee3-4f25-4ec3-a529-f297f60d43a0", null, "Admin", "ADMIN" },
                    { "93a7415b-c6f9-4b4c-a97c-db82e5f256e8", null, "Employer", "EMPLOYER" },
                    { "c018988c-131b-4982-9a86-9cc7c1a806ea", null, "Candidate", "CANDIDATE" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApplyForm_CandidateID",
                table: "ApplyForm",
                column: "CandidateID");
